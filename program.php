...
success:function(data)
{
   $("#content").html(data);
          ...
          <h3 class="page-header"> ACTIVITY <small> Program</small></h3>
        ...
        <h3>Add New Activity</h3>
          <form class="" method="post" >
            ...
            <div class="form-group">
              <label for="sub" class="cols-sm-2 control-label">Activity</label>
              <div class="cols-sm-4">
                <div class="input-group">
                  <input type="text" class="form-control" name="cur" id="sub"
                  style="width:225px"  placeholder="Enter Activity" value="<?php if(isset($_POST['cur'])){echo $_POST['cur'];} ?>"/>
                  <p>
