    ...
    #stud{
      ...
      top:0px;
		...
		#stud{
          ...
          <h1 class="page-header">List of Candidates are Promoted      <button type="text" class="btn btn-info" onclick="printContent('stud')" >
	...
	<tr>
		...
		<p><b>Student Activity System</b></p>
		<p>Selected Candidates for Activities</p>
