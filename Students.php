...
<div class="form-group">
  <label class="col-xs-4 control-label" for="lrn">Roll No</label>  
  <div class="col-xs-6">
...
<div class="form-group">
  ...
  <table id="students" class="table table-bordered table-condensed">
    ...
    ?>
     ...
     <a  class="btn btn-info" data-toggle="modal" data-target="#view-modal" data-id="<?php echo $sid ?>" id="getUser">View Status</a>
     </td>
       </tr>
